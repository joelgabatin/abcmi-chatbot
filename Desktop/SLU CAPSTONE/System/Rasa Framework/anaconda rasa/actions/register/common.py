...
from database import Database, RegisterHelp, SiteSettings
...
def get_register_help_text(topic: Text) -> Text:
    return RegisterHelp.get_help(topic) or ""


def get_register_page_url() -> Text:
    return RegisterHelp.get_register_page_url(db)
